...
class DataModule:
    ...
    def _init_datasets(self):
        ...
        self.ds_c_test = DatasetC(cfg.root_c,"test",cfg.max_size, num_channels = 3)
        ...
        self.ds_b_test = DatasetB(cfg.root_b,"test",cfg.label_map,cfg.max_size,num_channels=3)
        self.ds_d_test =  DatasetD(cfg.root_d_xml,cfg.root_d_img,cfg.label_map,cfg.max_size,num_channels=3) #ds D is all test for now. 
